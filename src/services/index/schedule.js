...
export const deleteSchedule = async ({ slug, token }) => {
  try {
    const config = {
      headers: {
...
export const updateSchedule = async ({ updatedData, slug, token }) => {
  try {
    const config = {
      headers: {
        Authorization: `Bearer ${token}`,
...
export const createSchedule = async ({ newScheduleData, token }) => {
  try {
    const config = {
      headers: {
        Authorization: `Bearer ${token}`,
