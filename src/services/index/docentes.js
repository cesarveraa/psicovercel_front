...
export const getDocente = async (id) => {
  try {
    const { data } = await axios.get(`/api/docente/${id}`);
    return data;
  } catch (error) {
    if (error.response && error.response.data.message)
      throw new Error(error.response.data.message);
...
export const deleteDocente = async ({ id, token }) => {
  try {
    ...
    const { data } = await axios.delete(`/api/docentes/${id}`, config);
    return data;
  } catch (error) {
    if (error.response && error.response.data.message)
      throw new Error(error.response.data.message);
...
export const updateDocente = async ({ updatedData, id, token }) => {
  try {
    ...
    const { data } = await axios.put(`/api/docentes/${id}`, updatedData, config);
    return data;
  } catch (error) {
    if (error.response && error.response.data.message)
      throw new Error(error.response.data.message);
...
export const createDocente = async ({ docenteData, token }) => {
  try {
    ...
    const { data } = await axios.post(`/api/docentes`, docenteData, config);
    return data;
  } catch (error) {
    if (error.response && error.response.data.message)
      throw new Error(error.response.data.message);
